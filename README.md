...
We used Generative AI Assistance when we were working on this project. We got help from AI tools like ChatGPT and GitHub Copilot. They assisted us with writing basic Python code to get good pictures, from the iNaturalist API. They wrote the versions of the scripts to export to ONNX and to make PyTorch use less space.
